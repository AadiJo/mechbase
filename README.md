...
`inspect_candidates`, even when the user does not explicitly ask to inspect or display images.
Only visually relevant inspected assets continue to `render_search_results`; if none are useful,
